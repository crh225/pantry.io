...
export const DetailTags: React.FC<Props> = ({ recipe }) => {
  ...
  return (
    <div className="detail-tags">
      ...
      {recipe.nutrition?.calories && <span className="tag"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{verticalAlign:'middle',marginRight:3}}><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg> {recipe.nutrition.calories} cal/serving</span>}
